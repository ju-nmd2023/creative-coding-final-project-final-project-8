...
function preload() {
  soundFormats("mp3");
  bgMusic = loadSound("music/copyrightfree-background-music.mp3");
  // Key board sound effects
  soundEffects.a = loadSound("music/sound-effect.mp3");
  soundEffects.s = loadSound("music/sound-effect.mp3");
  soundEffects.d = loadSound("music/sound-effect.mp3");
  soundEffects.f = loadSound("music/sound-effect.mp3");
}

function setup() {
  createCanvas(windowWidth, windowHeight);
  noStroke();
  bgMusic.setVolume(0.4); // Set background music volume
